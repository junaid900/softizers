...
$results = $conf->fetchall( HEAD ." ORDER BY `head_id` DESC");
?>
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="x_panel">
            <button type="submit" onClick="window.location.href='add_head.php'" class="btn btn-primary right" name="">Add Hospital</button>
            <!----------- Page Content ----------->
            <div class="x_content">
                    ...
                    <table class="table table-striped table-bordered bulk_action" id="datatable-checkbox">
                        ...
                        <?php foreach ($results as $x) { ?>
                            <tr>
                                ...
                                <td>
                                    <?php $cat = $conf->select("*",CATEGORIES,"id=".$x->cat_id);?>
                                    <?php echo $cat[0]->category_name; ?>
                                </td>
                                <td>
